 ...
 */
internal class Orchestrator<out T : Identifiable>(input: T, steps: Iterator<StepDescriptor<T>>, private val launchContext: CoroutineContext, private val failureListener: ((Orchestrator<T>) -> Unit)? = null) : Identifiable {
